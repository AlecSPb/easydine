     ...
     // initialise form widget
       ...
       // show_order =(Button)findViewById(R.id.Show_Order_btn);
		...
		try {
            ...
            Toast.makeText(OrderScreen.this, ""+price ,Toast.LENGTH_SHORT).show();
        }
        catch (Exception e){

            e.printStackTrace();

            Toast.makeText(OrderScreen.this, e.toString(), Toast.LENGTH_SHORT).show();
        }
	...
	public void onClick(View v) {
		...
		//on button click place order
			...
			startActivity(mIntent);*/
                ...
                Toast.makeText(OrderScreen.this, "Fill quantity please!", Toast.LENGTH_SHORT).show();
                finish();
            }
	}
